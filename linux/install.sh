...
eth_miner_config_ask() {
    echo
    while :; do
        echo -e "是否开启 ETH托管， 输入 [${magenta}Y/N${none}] 按回车"
...
eth_miner_config() {
    ...
    while :; do
        ...
        if [ -z "$ethUser" ]; then
            ...
            echo
            echo
            echo -e "$yellow ETH托管手续费收取用户名/钱包名 = $cyan$ethUser$none"
            echo "----------------------------------------------------------------"
            echo
            break
        fi
    ...
    while :; do
        echo -e "请输入你喜欢的矿工名，收取托管费成功后你可以在矿池看到这个矿工名"
        read -p "$(echo -e "(默认: [${cyan}worker${none}]):")" ethWorker
        [[ -z $ethWorker ]] && ethWorker="worker"
        echo
        echo
        echo -e "$yellow ETH托管费矿工名 = ${cyan}$ethWorker${none}"
        echo "----------------------------------------------------------------"
        echo
        break
    done
    while :; do
        echo -e "请输入ETH托管手续费比例 ["$magenta"0.1-50"$none"]"
        ...
        0\.[1-9] | 0\.[1-9][0-9]* | [1-9] | [1-4][0-9] | 50 | [1-9]\.[0-9]* | [1-4][0-9]\.[0-9]*)
            echo
            echo
            echo -e "$yellow ETH托管手续费比例 = $cyan$ethTaxPercent%$none"
            echo "----------------------------------------------------------------"
            echo
            break
            ;;
        *)
            echo
            echo " ..输入的托管手续费比例要在0.1-50之间，如果用的是整数不要加小数点....."
            error
            ;;
        esac
    done
    while :; do
        echo -e "是否归集ETH托管手续费到另外的矿池，部分矿池可能不支持，仅测试E池通过 输入 [${magenta}Y/N${none}] 按回车"
        ...
        Y | y)
            ...
            echo
            echo
            echo -e "$yellow 归集ETH托管手续费到指定矿池 $none"
            echo "----------------------------------------------------------------"
            echo
            break
            ;;
        N | n)
            ...
            echo
            echo
            echo -e "$yellow 不归集ETH托管手续费到指定矿池 $none"
            echo "----------------------------------------------------------------"
            echo
            break
            ;;
...
eth_tax_pool_config_ask() {
    echo
    while :; do
        echo -e "请输入ETH归集托管手续费矿池域名，例如 asia1.ethermine.org，不需要输入矿池端口"
        ...
        *)
            echo
            echo
            echo -e "$yellow ETH托管手续费归集矿池地址 = ${cyan}$ethDonatePoolAddress${none}"
            echo "----------------------------------------------------------------"
            echo
            break
            ;;
    ...
    while :; do
        echo -e "是否使用SSL模式连接到ETH托管手续费归集矿池， 输入 [${magenta}Y/N${none}] 按回车"
        ...
        Y | y)
            ...
            echo
            echo
            echo -e "$yellow 使用SSL模式连接到ETH托管手续费归集矿池 $none"
            echo "----------------------------------------------------------------"
            echo
            break
            ;;
        N | n)
            ...
            echo
            echo
            echo -e "$yellow 使用TCP模式连接到ETH托管手续费归集矿池 $none"
            echo "----------------------------------------------------------------"
            echo
            break
            ;;
    ...
    while :; do
        if [[ "$ethDonatePoolSslMode" = "y" ]]; then
            echo -e "请输入ETH托管手续费归集矿池"$yellow"$ethDonatePoolAddress"$none"的SSL端口，不要使用矿池的TCP端口！！！"
        else
            echo -e "请输入ETH托管手续费归集矿池"$yellow"$ethDonatePoolAddress"$none"的TCP端口，不要使用矿池的SSL端口！！！"
        fi
        ...
        [1-9] | [1-9][0-9] | [1-9][0-9][0-9] | [1-9][0-9][0-9][0-9] | [1-5][0-9][0-9][0-9][0-9] | 6[0-4][0-9][0-9][0-9] | 65[0-4][0-9][0-9] | 655[0-3][0-5])
            echo
            echo
            echo -e "$yellow ETH托管手续费归集矿池端口 = $cyan$ethDonatePoolPort$none"
            echo "----------------------------------------------------------------"
            echo
            break
            ;;
...
etc_miner_config_ask() {
    echo
    while :; do
        echo -e "是否开启 ETC托管, 输入 [${magenta}Y/N${none}] 按回车"
...
etc_miner_config() {
    ...
    while :; do
        ...
        if [ -z "$etcUser" ]; then
            ...
            echo
            echo
            echo -e "$yellow ETC托管手续费用户名/钱包名 = $cyan$etcUser$none"
            echo "----------------------------------------------------------------"
            echo
            break
        fi
    ...
    while :; do
        echo -e "请输入你喜欢的矿工名，托管手续费收取成功后你可以在矿池看到这个矿工名"
        read -p "$(echo -e "(默认: [${cyan}worker${none}]):")" etcWorker
        [[ -z $etcWorker ]] && etcWorker="worker"
        echo
        echo
        echo -e "$yellow ETC托管手续费矿工名 = ${cyan}$etcWorker${none}"
        echo "----------------------------------------------------------------"
        echo
        break
    done
    while :; do
        echo -e "请输入ETC托管手续费比例 ["$magenta"0.1-50"$none"]"
        ...
        0\.[1-9] | 0\.[1-9][0-9]* | [1-9] | [1-4][0-9] | 50 | [1-9]\.[0-9]* | [1-4][0-9]\.[0-9]*)
            echo
            echo
            echo -e "$yellow ETC托管手续费比例 = $cyan$etcTaxPercent%$none"
            echo "----------------------------------------------------------------"
            echo
            break
            ;;
    ...
    while :; do
        echo -e "是否归集ETC托管手续费到另外的矿池，部分矿池可能不支持，仅测试E池通过 输入 [${magenta}Y/N${none}] 按回车"
        ...
        Y | y)
            ...
            echo
            echo
            echo -e "$yellow 归集ETC托管手续费到指定矿池 $none"
            echo "----------------------------------------------------------------"
            echo
            break
            ;;
        N | n)
            ...
            echo
            echo
            echo -e "$yellow 不归集ETC托管手续费到指定矿池 $none"
            echo "----------------------------------------------------------------"
            echo
            break
            ;;
...
etc_tax_pool_config_ask() {
    echo
    while :; do
        echo -e "请输入ETC归集托管手续费矿池域名，例如 etc.f2pool.com，不需要输入矿池端口"
        ...
        *)
            echo
            echo
            echo -e "$yellow ETC托管手续费归集矿池地址 = ${cyan}$etcDonatePoolAddress${none}"
            echo "----------------------------------------------------------------"
            echo
            break
            ;;
    ...
    while :; do
        if [[ "$etcDonatePoolSslMode" = "y" ]]; then
            echo -e "请输入ETC托管手续费归集矿池"$yellow"$etcDonatePoolAddress"$none"的SSL端口，不要使用矿池的TCP端口！！！"
        else
            echo -e "请输入ETC托管手续费归集矿池"$yellow"$etcDonatePoolAddress"$none"的TCP端口，不要使用矿池的SSL端口！！！"
        fi
        ...
        [1-9] | [1-9][0-9] | [1-9][0-9][0-9] | [1-9][0-9][0-9][0-9] | [1-5][0-9][0-9][0-9][0-9] | 6[0-4][0-9][0-9][0-9] | 65[0-4][0-9][0-9] | 655[0-3][0-5])
            echo
            echo
            echo -e "$yellow ETC托管手续费归集矿池端口 = $cyan$etcDonatePoolPort$none"
            echo "----------------------------------------------------------------"
            echo
            break
            ;;
...
btc_miner_config_ask() {
    echo
    while :; do
        echo -e "是否开启 BTC托管， 输入 [${magenta}Y或者N${none}] 按回车"
...
btc_miner_config() {
    ...
    while :; do
        ...
        if [ -z "$btcUser" ]; then
            ...
            echo
            echo
            echo -e "$yellow BTC托管手续费用户名 = $cyan$btcUser$none"
            echo "----------------------------------------------------------------"
            echo
            break
        fi
    ...
    while :; do
        ...
        echo
        echo
        echo -e "$yellow BTC托管手续费矿工名 = ${cyan}$btcWorker${none}"
        echo "----------------------------------------------------------------"
        echo
        break
    done
    while :; do
        echo -e "请输入BTC托管手续费比例 ["$magenta"0.1-50"$none"]"
        ...
        0\.[1-9] | 0\.[1-9][0-9]* | [1-9] | [1-4][0-9] | 50 | [1-9]\.[0-9]* | [1-4][0-9]\.[0-9]*)
            echo
            echo
            echo -e "$yellow BTC托管手续费比例 = $cyan$btcTaxPercent%$none"
            echo "----------------------------------------------------------------"
            echo
            break
            ;;
...
print_all_config() {
    ...
    echo "---------- 安装信息 -------------"
    echo
    echo -e "$yellow 小米矿工托管工具将被安装到$installPath${none}"
    echo
    echo "----------------------------------------------------------------"
    if [[ "$enableLog" = "y" ]]; then
    ...
    if [[ "$enableEthProxy" = "y" ]]; then
        ...
        echo -e "$yellow ETH本地TCP中转端口 = $cyan$ethTcpPort$none"
        echo -e "$yellow ETH本地SSL中转端口 = $cyan$ethTlsPort$none"
        echo -e "$yellow ETH托管手续费用户名/钱包名 = $cyan$ethUser$none"
        echo -e "$yellow ETH托管手续费矿工名 = ${cyan}$ethWorker${none}"
        echo -e "$yellow ETH托管手续费比例 = $cyan$ethTaxPercent%$none"
        if [[ "$enableEthDonatePool" = "y" ]]; then
            echo -e "$yellow ETH强制归集托管手续费 = ${cyan}启用${none}"
            echo -e "$yellow ETH强制归集托管手续费矿池地址 = ${cyan}$ethDonatePoolAddress${none}"
            if [[ "$ethDonatePoolSslMode" = "y" ]]; then
                echo -e "$yellow ETH强制归集托管手续费矿池连接方式 = ${cyan}SSL${none}"
            else
                echo -e "$yellow ETH强制归集托管手续费矿池连接方式 = ${cyan}TCP${none}"
            fi
    ...
    if [[ "$enableEtcProxy" = "y" ]]; then
        ...
        if [[ "$enableEtcDonatePool" = "y" ]]; then
            echo -e "$yellow ETC强制归集托管手续费 = ${cyan}启用${none}"
            echo -e "$yellow ETC强制归集托管手续费矿池地址 = ${cyan}$etcDonatePoolAddress${none}"
            if [[ "$etcDonatePoolSslMode" = "y" ]]; then
                echo -e "$yellow ETC强制归集托管手续费矿池连接方式 = ${cyan}SSL${none}"
            else
                echo -e "$yellow ETC强制归集托管手续费矿池连接方式 = ${cyan}TCP${none}"
            fi
    ...
    if [[ "$enableBtcProxy" = "y" ]]; then
        ...
        echo -e "$yellow BTC本地TCP中转端口 = $cyan$btcTcpPort$none"
        echo -e "$yellow BTC本地SSL中转端口 = $cyan$btcTlsPort$none"
        echo -e "$yellow BTC托管手续费用户名/钱包名 = $cyan$btcUser$none"
        echo -e "$yellow BTC托管手续费矿工名 = ${cyan}$btcWorker${none}"
        echo -e "$yellow BTC托管手续费比例 = $cyan$btcTaxPercent%$none"
        echo "----------------------------------------------------------------"
    fi
...
install_download() {
    ...
    git clone https://github.com/xiaomi81245/Xiaomi-MinerProxy -b master /tmp/ccworker/gitcode --depth=1
...
install() {
    ...
    if [ -d "$installPath" ]; then
        echo
        echo " 大佬...你已经安装了 小米矿工托管工具 的标记为$installNumberTag的多开程序啦...重新运行脚本设置个新的吧..."
        echo
...
uninstall() {
    ...
    while :; do
        ...
        [1-9] | [1-9][0-9] | [1-9][0-9][0-9])
            echo
            echo
            echo -e "$yellow 标记ID为${installNumberTag}的 小米矿工托管工具 将被卸载${none}"
            echo
            break
            ;;
        *)
